import unittest
from Hexagonal.appli.interf_v2 import GUIApp
...
class MyTestCase(unittest.TestCase):
    ...
    def test_palindrome_check_true(self):
        ...
        self.assertEqual(self.app.result_label['text'], "Well said!")
    ...
    def test_palindrome_check_false(self):
        ...
        self.app.check_palindrome()
        self.assertEqual(self.app.result_label['text'], "Mirrored : nohtyp")
